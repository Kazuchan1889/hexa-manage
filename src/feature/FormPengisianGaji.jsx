...
const FormPengisianGaji = ({
  ...
  const [isKasbonValid, setisKasbonValid] = useState(false);
  ...
  const [formDataBulananCompleted, setformDataBulananCompleted] =
    useState(false);
  ...
  return (
    <div>
      <div className="flex items-center justify-between space-y-5">
        ...
        >
          <MenuItem onClick={() => switchForm("Bulanan")}>
            <p className="text-gray-500">Bulanan</p>
          </MenuItem>
          <MenuItem onClick={() => switchForm("THR")}>
            <p className="text-gray-500">THR</p>
          </MenuItem>
        </Menu>
      </div>
        ...
        {formType === "Bulanan" && (
          <div className="space-y-4">
            ...
            <TextField
              label="Kasbon"
              fullWidth
              value={formatedValue(formDataBulanan.kasbon)}
              onChange={(e) => {
                const numericValue = e.target.value.replace(/[^0-9]/g, "");
                handleInputChangeBulanan(e, numericValue);
                setisKasbonValid(!!numericValue);
              }}
              name="kasbon"
              InputProps={{
                startAdornment: (
              ...
              error={!isKasbonValid}
              helperText={!isKasbonValid && "Wajib Diisi"}
            />
            <TextField
              label="BPJS"
              fullWidth
