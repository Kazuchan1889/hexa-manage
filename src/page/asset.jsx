  ...
  // kalo yang humberger menu masi gbisa buat delet di ganti jadi ambil dari nama trus buat edit entah
  ...
  const TableAsset = () => {
    ...
    const [editData, setEditData] = useState({
      ...
      const handleDelete = async(id) => {
        ...
        const apiURLdelete = `${ip}/api/asset/list/del/${selectedRow.id}`;
      ...
      const handleEditSave = async (id) => {
        const apiURLupdate = `${ip}/api/asset/list/patch/${selectedRowId}`;
        ...
        axios
          .patch(apiURLupdate, JSON.stringify(editData), config) // Menggunakan JSON.stringify untuk mengubah objek ke JSON
          .then((response) => {
          ...
          .catch((error) => {
            ...
            Swal.fire("Error!", "There was an error updating the asset.", "error");
          });
      };
