...
function DashboardUser() {
  ...
  return (
    ...
    >
      <NavbarUser />
      <div className="flex h-fit " style={{ backgroundColor: "#F0F0F0" }}>
        <div className="h-full w-[95%] flex flex-col justify-center items-center mx-auto">
          ...
          <div className="mb-12 mr-100 flex flex-col lg:flex-row justify-between items-center w-full h-fit lg:h-1/2">
            {!isMobile && (
          ...
          <div className="w-[100%] lg:w-[69.5%] h-[39rem] lg:h-[23rem] lg:mr-100 ml-auto mb-4 drop-shadow-lg bg-white p-10 rounded-xl border">
