            ...
            <div className=''>
                <div className="my-4 flex justify-center">
                    <form onSubmit={handleSubmit}>
                        <div className='w-full border p-8 rounded-3xl drop-shadow-lg bg-white'>
                            ...
                            <div className="mb-2">
                                ...
                                <input type="text" id="note" name="note" value={formData.note} onChange={handleInputChange}
                                    className=" w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            </div>
                            <div className="mb-2">
                            ...
                            <div className="mb-2">
                                ...
                                <input type="time" id="mulai" name="mulai" value={formData.mulai} onChange={handleInputChange}
                                    className=" w-[47%] rounded-md border-0 py-1.5 px-4 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                <span className=''> - </span>
