                      ...
                      <Table size="small">
                        <TableHead>
                          <TableRow style={{ backgroundColor: "#204684" }}>
                            {(isMobile
                              ? ["Details", "Location", "Read Detail"]
                              : ["Details", "Location", "Time", "Report Date", "Type", "Evidence", "Read Detail"]
                            ).map((header) => ( // Hapus titik sebelum .map
                              <TableCell
                                key={header}
                                align="center"
                        ...
                        <TableBody>
                          {tableData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => (
                            <TableRow key={index}>
                              ...
                              {!isMobile && <TableCell align="center">{row.time}</TableCell>}
                              {!isMobile && <TableCell align="center">{row.tanggal}</TableCell>}
                              {!isMobile && <TableCell align="center">{row.jenis}</TableCell>}
                              {!isMobile && (
