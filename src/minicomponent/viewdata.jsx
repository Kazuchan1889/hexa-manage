...
function ViewData() {
  ...
  return (
    <div className="container mx-auto p-6 h-[20rem] overflow-y-auto">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-800">Day Of Balance</h2>
        <p className="text-lg font-semibold text-gray-700">{cutiMandiri !== null ? `${cutiMandiri} Days` : '0'}</p>
        <a className="flex justify-center items-center mt-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-300" href="/cuti">
          Form Cuti
      ...
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-800">Day Of Used</h2>
        <p className="text-lg font-semibold text-gray-700">{sisaJatah !== null ? `${sisaJatah} Days` : '0'}</p>
        <a className="flex justify-center items-center mt-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-300" href="/izin">
          Form Izin
          <svg className="ml-2" viewBox="0 0 24 24" fill="currentColor" height="1.5em" width="1em">
            <path d="M18.59 13H3a1 1 0 010-2h15.59l-5.3-5.3a1 1 0 111.42-1.4l7 7a1 1 0 010 1.4l-7 7a1 1 0 01-1.42-1.4l5.3-5.3z" />
          </svg>
